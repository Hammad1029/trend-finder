...
2. Architecture: "Hub & Spoke"
   ...
   The Memory (Supabase): Stores products and uses Vector Embeddings to cluster similar items (e.g., clustering "Red Toy" and "Crimson Play Set").
...
3. Data Flow & Logic
   ...
   Store in Supabase. Use pgvector to cluster similar items to avoid UI clutter.
   Visualization (Next.js): Frontend polls Supabase via Realtime/SWR to display clustered trends.
